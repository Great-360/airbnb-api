...
export async function forgotPassword(req, res) {
    ...
    await sendEmail(email, "Password Reset", `<p>Click the link below to reset your password:</p>
...
export async function resetPassword(req, res) {
    ...
    await sendEmail(user.email, "Password Reset Confirmation", passwordResetEmail(user.name, `http://localhost:3000/reset-password/${tokenStr}`));
