...
export type GetListingPhotoAggregateType<T extends ListingPhotoAggregateArgs> = {
    [P in keyof T & keyof AggregateListingPhoto]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateListingPhoto[P]> : Prisma.GetScalarType<T[P], AggregateListingPhoto[P]>;
};
...
export type GetListingPhotoGroupByPayload<T extends ListingPhotoGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<ListingPhotoGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof ListingPhotoGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], ListingPhotoGroupByOutputType[P]> : Prisma.GetScalarType<T[P], ListingPhotoGroupByOutputType[P]>;
}>>;
...
export type ListingPhotoCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<ListingPhotoFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ListingPhotoDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['ListingPhoto'];
        meta: {
            name: 'ListingPhoto';
        };
    };
     ...
     * })
    **/
    count<T extends ListingPhotoCountArgs>(args?: Prisma.Subset<T, ListingPhotoCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], ListingPhotoCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends ListingPhotoGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, ListingPhotoGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetListingPhotoGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
