...
export type BookingOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "checkIn" | "checkOut" | "totalPrice" | "status" | "createdAt" | "guestId" | "listingId", ExtArgs["result"]["booking"]>;
